 ...
 */
CAN_VPID_Controller::CAN_VPID_Controller(float Kp, float Ki, float Kd,
								       CANJaguar *source, PIDOutput *output1,
								       PIDOutput *output2, bool InvertOutputs,
								       float period, float kF) :
	m_semaphore (0)
{
 ...
 */
void CAN_VPID_Controller::CallCalculate(void *controller)
{
	CAN_VPID_Controller *control = (CAN_VPID_Controller*) controller;
	control->Calculate();
}
 ...
 */
void CAN_VPID_Controller::SetPID(float p, float i, float d)
{
	CRITICAL_REGION(m_semaphore)
	{
		m_P = p;
 ...
 */
float CAN_VPID_Controller::GetP()
{
	CRITICAL_REGION(m_semaphore)
	{
		return m_P;
 ...
 */
float CAN_VPID_Controller::GetI()
{
	CRITICAL_REGION(m_semaphore)
	{
		return m_I;
 ...
 */
float CAN_VPID_Controller::GetD()
{
	CRITICAL_REGION(m_semaphore)
	{
		return m_D;
 ...
 */
void CAN_VPID_Controller::SetContinuous(bool continuous)
{
	CRITICAL_REGION(m_semaphore)
	{
 ...
 */
void CAN_VPID_Controller::SetInputRange(float minimumInput, float maximumInput)
{
	CRITICAL_REGION(m_semaphore)
	{
 ...
 */
void CAN_VPID_Controller::SetOutputRange(float minimumOutput, float maximumOutput)
{
	CRITICAL_REGION(m_semaphore)
	{
 ...
 */
void CAN_VPID_Controller::SetSetpoint(float setpoint)
{
	CRITICAL_REGION(m_semaphore)
	{
 ...
 */
float CAN_VPID_Controller::GetSetpoint()
{
	float setpoint;
	CRITICAL_REGION(m_semaphore)
	{
 ...
 */
float CAN_VPID_Controller::GetError()
{
	float error;
	CRITICAL_REGION(m_semaphore)
	{
 ...
 */
void CAN_VPID_Controller::SetTolerance(float percent)
{
	CRITICAL_REGION(m_semaphore)
	{
		m_tolerance = percent;
 ...
 */
bool CAN_VPID_Controller::OnTarget()
{
	bool temp;
	CRITICAL_REGION(m_semaphore)
	{
 ...
 */
void CAN_VPID_Controller::Enable()
{
	CRITICAL_REGION(m_semaphore)
	{			
		m_enabled = true;
 ...
 */
void CAN_VPID_Controller::Disable()
{
	CRITICAL_REGION(m_semaphore)
	{
 ...
 */
bool CAN_VPID_Controller::IsEnabled()
{
	bool enabled;
	CRITICAL_REGION(m_semaphore)
	{
 ...
 */
void CAN_VPID_Controller::Reset()
{
	Disable();
